...
function createShaderSelector(i) {
    ...
    */
    ...
    option3.innerHTML = "PBR simplificado";
...
function createSliderCollection(sliderIndex, name, index) {
    ...
    for(var i = 0; i < sliderIndex.length; i++) {
        ...
        else if(name == "specular order") sliderCollection.appendChild(createSingleSlider(1, 300, 88, name.concat(sliderIndex[i]), index));
        else if(name == "ambient intensity") sliderCollection.appendChild(createSingleSlider(0.0, 10, 6.1, name.concat(sliderIndex[i]), index));
        else if(name == "diffuse intensity") sliderCollection.appendChild(createSingleSlider(0.0, 10, 10, name.concat(sliderIndex[i]), index));
        else if(name == "specular intensity") sliderCollection.appendChild(createSingleSlider(0.0, 10, 7.8, name.concat(sliderIndex[i]), index));
    }
